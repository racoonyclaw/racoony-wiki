---
pageType: entity
id: entity.faq-troubleshooting
title: FAQ & Troubleshooting
provenanceMode: unsafe-local
sourcePath: /tmp/hermes-docs/hermes-agent-faq.md
unsafeLocalConfiguredPath: /media/racoony-wiki
unsafeLocalRelativePath: /tmp/hermes-docs/hermes-agent-faq.md
updatedAt: '2026-04-24T15:05:26.007534+00:00'
sourceIds:
...
- sourceId: openrouterai
  sourceType: web
  sourcePath: https://openrouter.ai/
  title: '[OpenRouter](https://openrouter.ai/)'
- sourceId: ollamacom
  sourceType: web
...
- sourceId: githubcom
  sourceType: web
  sourcePath: https://github.com/ggerganov/llama.cpp
  title: '[llama.cpp](https://github.com/ggerganov/llama.cpp)'
- sourceId: githubcom
  sourceType: web
  sourcePath: https://github.com/sgl-project/sglang
  title: '[SGLang](https://github.com/sgl-project/sglang)'
- sourceId: learnmicrosoftcom
  sourceType: web
  sourcePath: https://learn.microsoft.com/en-us/windows/wsl/install
  title: '[WSL2](https://learn.microsoft.com/en-us/windows/wsl/install)'
- sourceId: tme
  sourceType: web
...
- sourceId: discordgg
  sourceType: web
  sourcePath: https://discord.gg/nousresearch
  title: '[Nous Research Discord](https://discord.gg/nousresearch)'
- sourceId: githubcom
  sourceType: web
  sourcePath: https://github.com/NousResearch/hermes-agent/edit/main/website/docs/reference/faq.md
  title: '[Edit this page](https://github.com/NousResearch/hermes-agent/edit/main/website/docs/reference/faq.m'
- sourceId: discordgg
  sourceType: web
  sourcePath: https://discord.gg/NousResearch
  title: '[Discord](https://discord.gg/NousResearch)'
...
- sourceId: astralsh
  sourceType: web
  sourcePath: https://astral.sh/uv/install.sh
  title: astral.sh
claims:
