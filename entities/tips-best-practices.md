---
pageType: entity
id: entity.tips-best-practices
title: Tips & Best Practices
provenanceMode: unsafe-local
sourcePath: /tmp/hermes-docs/hermes-agent-tips.md
unsafeLocalConfiguredPath: /media/racoony-wiki
unsafeLocalRelativePath: /tmp/hermes-docs/hermes-agent-tips.md
updatedAt: '2026-04-24T15:05:26.168069+00:00'
sourceIds:
...
- nousresearchcom
sources:
- sourceId: hermes-agentnousrese
  sourceType: web
  sourcePath: https://hermes-agent.nousresearch.com
  title: '[Home](https://hermes-agent.nousresearch.com)'
- sourceId: githubcom
  sourceType: web
  sourcePath: https://github.com/NousResearch/hermes-agent
  title: '[GitHub](https://github.com/NousResearch/hermes-agent)'
- sourceId: discordgg
  sourceType: web
  sourcePath: https://discord.gg/NousResearch
  title: '[Discord](https://discord.gg/NousResearch)'
- sourceId: githubcom
  sourceType: web
  sourcePath: https://github.com/NousResearch/hermes-agent/edit/main/website/docs/guides/tips.md
  title: '[Edit this page](https://github.com/NousResearch/hermes-agent/edit/main/website/docs/guides/tips.md)'
- sourceId: discordgg
  sourceType: web
  sourcePath: https://discord.gg/NousResearch
  title: '[Discord](https://discord.gg/NousResearch)'
- sourceId: githubcom
  sourceType: web
  sourcePath: https://github.com/NousResearch/hermes-agent/discussions
  title: '[GitHub Discussions](https://github.com/NousResearch/hermes-agent/discussions)'
- sourceId: agentskillsio
  sourceType: web
  sourcePath: https://agentskills.io
  title: '[Skills Hub](https://agentskills.io)'
- sourceId: githubcom
  sourceType: web
  sourcePath: https://github.com/NousResearch/hermes-agent
  title: '[GitHub](https://github.com/NousResearch/hermes-agent)'
- sourceId: nousresearchcom
  sourceType: web
  sourcePath: https://nousresearch.com
  title: '[Nous Research](https://nousresearch.com)'
- sourceId: nousresearchcom
  sourceType: web
  sourcePath: https://nousresearch.com
  title: '[Nous Research](https://nousresearch.com)'
...
tipUse `/verbose` to cycle through tool output display modes: off → new → all → verbose. The "all" mode is great for watching what the agent does; "off" is cleanest for simple Q&A.
...
tipKeep context files focused and concise. Every character counts against your token budget since they're injected into every single message.
...
warningMemory is a frozen snapshot — changes made during a session don't appear in the system prompt until the next session starts. The agent writes to disk immediately, but the prompt cache isn't invalidated mid-session.
...
tipRun `/usage` periodically to see your token consumption. Run `/insights` for a broader view of usage patterns over the last 30 days.
...
tipOn messaging platforms, sessions auto-reset after idle time (default: 24 hours) or daily at 4 AM. Adjust per-platform in `~/.hermes/config.yaml` if you need longer sessions.
## Security[​](#security)
...
warningWhen running in a container backend (Docker, Singularity, Modal, Daytona), dangerous command checks are skipped because the container is the security boundary. Make sure your container images are properly locked down.
...
[Edit this page](https://github.com/NousResearch/hermes-agent/edit/main/website/docs/guides/tips.md)[PreviousCredential Pools](/docs/user-guide/features/credential-pools)[NextRun Local LLMs on Mac](/docs/guides/local-llm-on-mac)- [Getting the Best Results](#getting-the-best-results)[Be Specific About What You Want](#be-specific-about-what-you-want)
- [Provide Context Up Front](#provide-context-up-front)
- [Use Context Files for Recurring Instructions](#use-context-files-for-recurring-instructions)
- [Let the Agent Use Its Tools](#let-the-agent-use-its-tools)
- [Use Skills for Complex Workflows](#use-skills-for-complex-workflows)
