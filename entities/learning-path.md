...
Start HereIf you haven't installed Hermes Agent yet, begin with the [[entities/installation|Installation]] guide](/docs/getting-started/[[entities/installation|Installation]]) and then run through the [[entities/quickstart|Quickstart]]](/docs/getting-started/[[entities/quickstart|Quickstart]]). Everything below assumes you have a working [[entities/installation|Installation]].
...
LevelGoalRecommended ReadingTime EstimateBeginnerGet up and running, have basic conversations, use built-in tools[[entities/installation|Installation]]](/docs/getting-started/[[entities/installation|Installation]]) → [[entities/quickstart|Quickstart]]](/docs/getting-started/[[entities/quickstart|Quickstart]]) → [CLI Usage](/docs/user-guide/cli) → [Configuration](/docs/user-guide/configuration)~1 hourIntermediateSet up messaging bots, use advanced features like memory, cron jobs, and skills[Sessions](/docs/user-guide/sessions) → [Messaging](/docs/user-guide/messaging) → [Tools](/docs/user-guide/features/tools) → [Skills](/docs/user-guide/features/skills) → [Memory](/docs/user-guide/features/memory) → [Cron](/docs/user-guide/features/cron)~2–3 hoursAdvancedBuild custom tools, create skills, train models with RL, contribute to the project[Architecture](/docs/developer-guide/architecture) → [Adding Tools](/docs/developer-guide/adding-tools) → [Creating Skills](/docs/developer-guide/creating-skills) → [RL Training](/docs/user-guide/features/rl-training) → [Contributing](/docs/developer-guide/contributing)~4–6 hours
