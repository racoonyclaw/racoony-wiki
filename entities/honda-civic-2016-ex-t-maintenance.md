---
title: Honda Civic 2016 EX-T Maintenance
...
- **VIN:** 19XFC1F39GE035159
- **License Plate:** KEH7484
- **Odometer:** ~150,000 miles
- **Owner's Manual:** `wiki/_attachments/honda-civic-2016-owners-manual.pdf`

## Transmission Fluid (CVT)

| Item | Spec |
|---|---|
| Fluid Type | Honda HCF-2 |
| Drain & Refill Capacity | 3.7 US qt (3.5 liters) |
| Drain Plug Crush Washer | **14mm aluminum** — Honda P/N `90471-PX4-000` |
| Fill Plug Crush Washer | Same as drain plug (`90471-PX4-000`) |
| Torque Spec (drain & fill bolts) | 32 lb-ft |
| Service Interval | Every 30,000 miles (or 2 years) under normal conditions |
| Severe Service (mountain driving) | Every 25,000 miles |

## CVT Notes
- **Dealer-only fluid** — HCF-2 must be purchased at a Honda dealer or authorized parts supplier
- Do NOT use generic CVT fluid — only Honda HCF-2
- No external transmission filter — only a drain plug crush washer replacement at each service
- Check fluid with engine off, warm, on level ground — dipstick is yellow, passenger side of engine bay

## Parts & Sources
- **Drain/Fill Plug Washer:** Genuine Honda `90471-PX4-000` (14mm aluminum crush washer)
  - Source: [HondaPartsNow — Civic Drain Plug Washer](https://www.hondapartsnow.com/oem-honda-civic-drain_plug_washer.html)
  - [College Hills Honda](https://www.collegehillshonda.com/product/90471-PX4-000.html)
  - [Honda Parts Connection](https://www.hondapartsconnection.com/oem-parts/honda-2001-2025-honda-washer-drain-plug-18mm-90471px4000)
  - [Honda Factory Parts](https://www.hondafactoryparts.com/oem-parts/honda-trans-pan-washer-90471px4000)
- **HCF-2 Fluid:** Purchase from Honda dealership

## Engine Oil
- **Type:** 0W-20 / 5W-30 (check manual for current spec)
...
- **[HondaPartsNow — Parts Diagrams by Trim](https://www.hondapartsnow.com/parts-list/2016-honda-civic--4dr_tour-kl_cvt/engine/transmission_assy.html)** — interactive parts diagrams
