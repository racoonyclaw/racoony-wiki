---
pageType: entity
id: entity.use-voice-mode-with-hermes
title: Use Voice Mode with Hermes
provenanceMode: unsafe-local
sourcePath: /tmp/hermes-docs/hermes-agent-use-voice-mode-with-hermes.md
unsafeLocalConfiguredPath: /media/racoony-wiki
unsafeLocalRelativePath: /tmp/hermes-docs/hermes-agent-use-voice-mode-with-hermes.md
updatedAt: '2026-04-24T15:05:26.054673+00:00'
sourceIds:
...
- sourceId: githubcom
  sourceType: web
  sourcePath: https://github.com/NousResearch/hermes-agent/edit/main/website/docs/guides/use-voice-mode-with-hermes.md
  title: '[Edit this page](https://github.com/NousResearch/hermes-agent/edit/main/website/docs/guides/use-voic'
- sourceId: discordgg
  sourceType: web
  sourcePath: https://discord.gg/NousResearch
  title: '[Discord](https://discord.gg/NousResearch)'
