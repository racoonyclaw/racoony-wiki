---
pageType: entity
id: entity.matrix-setup
title: Matrix Setup
provenanceMode: unsafe-local
sourcePath: /tmp/hermes-docs/matrix.md
unsafeLocalConfiguredPath: /media/racoony-wiki
unsafeLocalRelativePath: /tmp/hermes-docs/matrix.md
updatedAt: '2026-04-24T15:05:24.971416+00:00'
sourceIds:
- your-server
- matrixexampleorg
- your-server
...
- sourceId: your-server
  sourceType: web
  sourcePath: https://your-server/_matrix/client/v3/login
  title: your-server
- sourceId: matrixexampleorg
  sourceType: web
  sourcePath: https://matrix.example.org
  title: matrix.example.org
- sourceId: your-server
  sourceType: web
  sourcePath: https://your-server/_synapse/admin/v2/users/%40hermes%3Ayour-server/devices/DEVICE_ID
  title: your-server
- sourceId: ''
  sourceType: web
  sourcePath: https://,
...
- sourceId: your-server
  sourceType: web
  sourcePath: https://your-server/_matrix/client/v3/account/whoami
  title: your-server
- sourceId: mac-ip8642
  sourceType: web
  sourcePath: http://<mac-ip>:8642/health
  title: <mac-ip>:8642
- sourceId: '19216811008642'
  sourceType: web
  sourcePath: http://192.168.1.100:8642
  title: 192.168.1.100:8642
claims:
...
```prism-code dockerfile codeBlock_bY9V thin-scrollbar
...
[](#how-hermes-behaves)[](#session-model-in-matrix)[](#mention-and-threading-configuration)
