---
pageType: entity
id: entity.use-mcp-with-hermes
title: Use MCP with Hermes
provenanceMode: unsafe-local
sourcePath: /tmp/hermes-docs/hermes-agent-use-mcp-with-hermes.md
unsafeLocalConfiguredPath: /media/racoony-wiki
unsafeLocalRelativePath: /tmp/hermes-docs/hermes-agent-use-mcp-with-hermes.md
updatedAt: '2026-04-24T15:05:26.122305+00:00'
sourceIds:
...
- sourceId: githubcom
  sourceType: web
  sourcePath: https://github.com/NousResearch/hermes-agent/edit/main/website/docs/guides/use-mcp-with-hermes.md
  title: '[Edit this page](https://github.com/NousResearch/hermes-agent/edit/main/website/docs/guides/use-mcp-'
- sourceId: discordgg
  sourceType: web
  sourcePath: https://discord.gg/NousResearch
  title: '[Discord](https://discord.gg/NousResearch)'
