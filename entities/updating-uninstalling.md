---
pageType: entity
id: entity.updating-uninstalling
title: Updating & Uninstalling
provenanceMode: unsafe-local
sourcePath: /tmp/hermes-docs/updating-uninstalling.md
unsafeLocalConfiguredPath: /media/racoony-wiki
unsafeLocalRelativePath: /tmp/hermes-docs/updating-uninstalling.md
updatedAt: '2026-04-24T15:05:26.388166+00:00'
claims:
...
4. **Gateway auto-restart** — if the gateway service is running (systemd on Linux, launchd on macOS), it is automatically restarted after the update completes
...
DIRTY WORKING TREE AFTER UPDATE: If `git status --short` shows unexpected changes after `hermes update`, stop and inspect them before continuing.
